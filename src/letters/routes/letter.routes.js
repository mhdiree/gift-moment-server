...
// 편지 목록 조회 (로그인 상태)
router.get('/letters/:recipient_id', authMiddleware, letterController.getLettersForLoggedInUser);

// 편지 상세 조회 (로그인 상태)
router.get('/letters/:recipient_id/:letter_id', authMiddleware, letterController.getLetterDetails);
